<template>
  <div class="review-border rounded p-2 scroll" @click.prevent="goDetailReview(review.id)">
    <p class="m-0">
    ...
    <div class="review-count mt-1">
      <p class="m-0"><i class="fa-solid fa-thumbs-up mx-1"></i>{{ review.liked_users.length }}</p>
      <p class="m-0 me-2"><i class="fa-solid fa-comments mx-1"></i>{{ review.comment_set.length }}</p>
    </div>
  </div>
</template>
